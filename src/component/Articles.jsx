...
//     <div className="flex flex-wrap lg:flex-nowrap justify-between px-10 py-12">
//       <div className="lg:w-1/2 w-full space-y-6 ml-40">
//         <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100 hover:text-blue-700 translate-x-1">
//           Writing Articles on software design, company building, Developer Ideas and the IT industry.
//         </h1>
//         <h1 className="text-lg font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100 hover:text-blue-700 translate-x-1">
//           Share your Experiences
//         </h1>
//         <div className="mt-8 space-y-16">
//           {articles.map((article, index) => (
